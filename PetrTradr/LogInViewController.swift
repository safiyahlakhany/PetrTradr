...
class LogInViewController: UICollectionViewController, UITextFieldDelegate {
    ...
    @objc func dismissKeyboard()  // this was throwing the error "unrecognized selector sent to instance"
    {
